...
namespace Algar.Hours.Application.DataBase.HorusReport.Commands.Create
{
    public class CreateHorusReportCommand : ICreateHorusReportCommand
    {
        ...
        public async Task<PortalDBModel> ExecutePortal(CreateHorusReportModel model)
        {
            ...
            var horasExceptuadasDia = _dataBaseService.UsersExceptions.FromSqlRaw($"SELECT ue.* FROM \"UsersExceptions\" ue WHERE ue.\"UserId\" = '{horusModel.UserEntityId}' and ue.\"ReportType\" = 'STANDBY' AND ue.\"StartDate\" >= TO_TIMESTAMP('{dateTime.ToString("dd/MM/yyyy")} 00:00', 'DD/MM/YYYY HH24:MI') AND ue.\"StartDate\" <= TO_TIMESTAMP('{dateTime.ToString("dd/MM/yyyy")} 23:59', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => x.horas).Sum();
            var HorasPortalDBTDia = _dataBaseService.HorusReportEntity.FromSqlRaw($"SELECT * FROM \"HorusReportEntity\" h WHERE h.\"UserEntityId\" = '{horusModel.UserEntityId}' AND h.\"Estado\" IN ({string.Join(",", status)}) AND h.\"Origen\" = 'STANDBY' AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') >= TO_TIMESTAMP('{dateTime.ToString("dd/MM/yyyy")} 00:00', 'DD/MM/YYYY HH24:MI') AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') <= TO_TIMESTAMP('{dateTime.ToString("dd/MM/yyyy")} 23:59', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => double.Parse(x.CountHours)).Sum();
            ...
            var horasExceptuadasSemana = _dataBaseService.UsersExceptions.FromSqlRaw($"SELECT ue.* FROM \"UsersExceptions\" ue WHERE ue.\"UserId\" = '{horusModel.UserEntityId}' and ue.\"ReportType\" = 'STANDBY' AND ue.\"StartDate\" >= TO_TIMESTAMP('{dateTimeInicioSemana.ToString("dd/MM/yyyy")} 00:00', 'DD/MM/YYYY HH24:MI') AND ue.\"StartDate\" <= TO_TIMESTAMP('{dateTimeFinSemana.ToString("dd/MM/yyyy")} 23:59', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => x.horas).Sum();
            var HorasPortalDBTSemana = _dataBaseService.HorusReportEntity.FromSqlRaw($"SELECT * FROM \"HorusReportEntity\" h WHERE h.\"UserEntityId\" = '{horusModel.UserEntityId}' AND h.\"Estado\" IN ({string.Join(",", status)}) AND h.\"Origen\" = 'STANDBY' AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') >= TO_TIMESTAMP('{dateTimeInicioSemana.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI') AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') <= TO_TIMESTAMP('{dateTimeFinSemana.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => double.Parse(x.CountHours)).Sum();
            ...
            var horasExceptuadasMes = _dataBaseService.UsersExceptions.FromSqlRaw($"SELECT ue.* FROM \"UsersExceptions\" ue WHERE ue.\"UserId\" = '{horusModel.UserEntityId}' and ue.\"ReportType\" = 'STANDBY' AND ue.\"StartDate\" >= TO_TIMESTAMP('{dateTimeInicioMes.ToString("dd/MM/yyyy")} 00:00', 'DD/MM/YYYY HH24:MI') AND ue.\"StartDate\" <= TO_TIMESTAMP('{dateTimeFinMes.ToString("dd/MM/yyyy")} 23:59', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => x.horas).Sum();
            var HorasPortalDBTMes = _dataBaseService.HorusReportEntity.FromSqlRaw($"SELECT * FROM \"HorusReportEntity\" h WHERE h.\"UserEntityId\" = '{horusModel.UserEntityId}' AND h.\"Estado\" IN ({string.Join(",", status)}) AND h.\"Origen\" = 'STANDBY' AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') >= TO_TIMESTAMP('{dateTimeInicioMes.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI') AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') <= TO_TIMESTAMP('{dateTimeFinMes.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => double.Parse(x.CountHours)).Sum();
            ...
            var horasExceptuadasAno = _dataBaseService.UsersExceptions.FromSqlRaw($"SELECT ue.* FROM \"UsersExceptions\" ue WHERE ue.\"UserId\" = '{horusModel.UserEntityId}' and ue.\"ReportType\" = 'STANDBY' AND ue.\"StartDate\" >= TO_TIMESTAMP('{dateTimeInicioAno.ToString("dd/MM/yyyy")} 00:00', 'DD/MM/YYYY HH24:MI') AND ue.\"StartDate\" <= TO_TIMESTAMP('{dateTimeFinAno.ToString("dd/MM/yyyy")} 23:59', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => x.horas).Sum();
            var HorasPortalDBTAno = _dataBaseService.HorusReportEntity.FromSqlRaw($"SELECT * FROM \"HorusReportEntity\" h WHERE h.\"UserEntityId\" = '{horusModel.UserEntityId}' AND h.\"Estado\" IN ({string.Join(",", status)}) AND h.\"Origen\" = 'STANDBY' AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') >= TO_TIMESTAMP('{dateTimeInicioAno.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI') AND TO_TIMESTAMP(h.\"StrStartDate\", 'DD/MM/YYYY HH24:MI') <= TO_TIMESTAMP('{dateTimeFinAno.ToString("dd/MM/yyyy HH:mm")}', 'DD/MM/YYYY HH24:MI')").ToList().Select(x => double.Parse(x.CountHours)).Sum();
